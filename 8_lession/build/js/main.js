...
console.log(isTrue('deep'));
console.log(isTrue(''));
console.log(isTrue(null));
console.log(isTrue(undefined));
console.log(isTrue({}));
console.log(isTrue({ name: 'deep' }));
console.log(isTrue([]));
...
// console.log(processUser({name:'deep'})) // error
// our object must have an id because T extends HasID
...
// because we initialized it with string data
const myStore = new StateObject([15]);
myStore.state = (['deep', 23, true]);
